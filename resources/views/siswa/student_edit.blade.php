                    ...
                    <table class="table table-striped tab-content" id="1">
                        ...
                        <tbody>
                            <tr>
                                <td>Nama Lengkap</td>
                                <td>
                                    <input class="form-input" type="hidden" name="nisn" value="{{ $item->nisn }}">
                            ...
                            <tr>
                                <td>No. KK</td>
                                <td><input class="form-input" type="text" name="no_kk" value="{{ $item->no_kk }}">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input class="form-input" type="text" name="agama" value="{{ $item->agama }}">
                                </td>
                            </tr>
                            {{-- <tr>
                            ...
                            <tr>
                                <td>Alamat Jalan</td>
                                <td><input class="form-input" type="text" name="alamat" value="{{ $item->alamat }}">
                                </td>
                            </tr>
                            <tr>
                                <td>RT</td>
                            ...
                            <tr>
                                <td>Dusun</td>
                                <td><input class="form-input" type="text" name="dusun" value="{{ $item->dusun }}">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Bujur</td>
                                <td><input class="form-input" type="text" name="bujur" value="{{ $item->bujur }}">
                                </td>
                            </tr>
                ...
                <div id="3" class="tabcontent">
                    ...
                    <table class="table table-striped tab-content" id="2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>No. Telp/HP</td>
                                <td><input class="form-input" type="text" name="hp_ibu" value="{{ $item->hp_ibu }}">
                                </td>
                            </tr>
                        </tbody>
                    </table>
