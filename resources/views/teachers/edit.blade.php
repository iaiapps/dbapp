    ...
    @section('content')
        ...
        <div id="page_info" class="card rounded">
            ...
            <form action="{{ route('teacher_update', $item->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div id="1" class="tabcontent">
                    ...
                    <table class="table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>NIK</td>
                                <td><input class="form-control" type="text" name="nik" value="{{ $item->nik }}"></td>
                            </tr>
                            <tr>
                                <td>Jenis Kelamin</td>
                ...
                <div id="2" class="tabcontent">
                    ...
                    <table class="table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>RT</td>
                                <td><input class="form-control" type="text" name="rt" value="{{ $item->rt }}"></td>
                            </tr>
                            <tr>
                                <td>RW</td>
                                <td><input class="form-control" type="text" name="rw" value="{{ $item->rw }}"></td>
                            </tr>
                            <tr>
                                <td>Dusun</td>
                            ...
                            <tr>
                                <td>NPWP</td>
                                <td><input class="form-control" type="text" name="npwp" value="{{ $item->npwp }}"></td>
                            </tr>
                            <tr>
