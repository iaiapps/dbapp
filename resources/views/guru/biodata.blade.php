...
@section('content')
    <div class="leftright">
        ...
        <div class="tab tab-block">
            <li class="tab-item">
                <a href="#" @if (!Session::get('tabname'))
                    id="defaultOpen"
                    @endif class="tablinks" onclick="openTab(event, '1')">
                    Identitas
                </a>
            </li>
            <li class="tab-item">
                <a href="#" @if (Session::get('tabname') == 'pribadi')
                    id="defaultOpen"
                    @endif class="tablinks" onclick="openTab(event, '2')">
                    Data Pribadi
                </a>
            </li>

            <li class="tab-item">
                <a href="#" @if (Session::get('tabname') == 'pendidikan')
                    id="defaultOpen"
                    @endif class="tablinks" onclick="openTab(event, '3')">
                    Riwayat Pendidikan
                </a>
            </li>
            <li class="tab-item">
                <a href="#" @if (Session::get('tabname') == 'anak')
                    id="defaultOpen"
                    @endif class="tablinks" onclick="openTab(event, '4')">
                    Anak
                </a>
            </li>

            <li class="tab-item">
                <a href="#" @if (Session::get('tabname') == 'diklat')
                    id="defaultOpen"
                    @endif class="tablinks" onclick="openTab(event, '5')">
                    Diklat
                </a>
            </li>
        </div>
