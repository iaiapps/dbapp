        ...
        <div class="table table-responsive">
            <table id="example" class="display table-striped" style="width:100%">
                <tbody>
                    ...
                    <tr>
                        <th>Kode Pos</th>
                        <td><input type="text" class="form-control" name="kode_pos" value="{{ $item->kode_pos }}"></td>
                    </tr>
                    <tr>
                        <th>No Telp</th>
                        <td><input type="text" class="form-control" name="no_telp" value="{{ $item->no_telp }}"></td>
                    </tr>
                    <tr>
                        <th>Kelurahan</th>
                    ...
                    <tr>
                        <th>Provinsi</th>
                        <td><input type="text" class="form-control" name="provinsi" value="{{ $item->provinsi }}"></td>
                    </tr>
                    <tr>
                        <th>Website</th>
                        <td><input type="text" class="form-control" name="website" value="{{ $item->website }}"></td>
                    </tr>
                    <tr>
                        <th>Email</th>
